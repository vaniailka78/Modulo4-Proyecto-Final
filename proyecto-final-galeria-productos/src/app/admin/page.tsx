    ...
    const columns: GridColDef[] = [
        ...
        { field: 'price', headerName: 'Precio', width: 70 },
        {
            ...
            renderCell: (params: GridRenderCellParams) => (
                <>
                    <Button color={"secondary"} startIcon={<EditOutlinedIcon />} onClick={() => {
                        setIsAddDialogOpen(true);
                        setEditingProducts(params.row as Productos);
                    }}><b>Editar</b></Button>
                    <Button color={"secondary"}  startIcon={<DeleteOutlineOutlinedIcon />}
    ...
    return (
        <Container maxWidth="lg">
            <Box sx={{my: 4}}>
                ...
                <Button variant="contained" color="secondary" startIcon={<AddCircleOutlineIcon />} sx={{
